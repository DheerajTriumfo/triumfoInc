			...
			<div className="topheader">
				<div className="container mx-auto px-4">
					<div className="innerheader">
						<div className="logo"><Link href="/"><Image src="/images/logo.webp" width={135} height={71} alt="Triumfo Inc" loading="eager" /></Link></div>
						<div className="flex items-center gap-x-4 mr-12 lg:mr-0">
							<Link href="" className="flex text-white text-l items-center gap-x-1 hidden md:flex"><Image src="/images/mailicon.webp" width={36} height={17} alt="email" /> enquiry@triumfo.us</Link>
