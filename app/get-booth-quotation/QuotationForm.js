...
export default function QuotationForm({ defaultBoothSize = '', defaultEventName = '' }) {
	...
	return (
		<form onSubmit={onSubmit} className="grid grid-cols-12 gap-y-4 gap-x-6">
			...
			<div className="grid col-span-6"><input type="text" name="name" placeholder="Your Name" className="w-full px-3 mb-4 py-4 bg-[#ffffff] border border-gray-300 rounded-md text-base focus:outline-none focus:ring-2 focus:ring-blue-400 focus:border-blue-400 text-base"/></div>
			<div className="grid col-span-6"><input type="email" name="email" placeholder="Email ID" className="w-full px-3 mb-4 py-4 bg-[#ffffff] border border-gray-300 rounded-md text-base focus:outline-none focus:ring-2 focus:ring-blue-400 focus:border-blue-400 text-base"/></div>
			<div className="grid col-span-6"><input type="tel" name="phone" placeholder="Phone Number" className="w-full px-3 mb-4 py-4 bg-[#ffffff] border border-gray-300 rounded-md text-base focus:outline-none focus:ring-2 focus:ring-blue-400 focus:border-blue-400 text-base"/></div>
			<div className="grid col-span-6"><input type="text" name="country" placeholder="Country Name" className="w-full px-3 mb-4 py-4 bg-[#ffffff] border border-gray-300 rounded-md text-base focus:outline-none focus:ring-2 focus:ring-blue-400 focus:border-blue-400 text-base"/></div>
			<div className="grid col-span-12"><textarea name="information" rows={4} placeholder="Your Requirement.." className="w-full px-3 mb-4 py-4 bg-[#ffffff] border border-gray-300 rounded-md text-base focus:outline-none focus:ring-2 focus:ring-blue-400 focus:border-blue-400 text-base"></textarea></div>
