...
export async function generateMetadata() {
  return await buildMetadata({
    ...
    description:
      "Watch client video testimonials showcasing real stories and real results. See how Triumfo Inc. delivers exceptional trade show booth design and exhibit solutions.",
