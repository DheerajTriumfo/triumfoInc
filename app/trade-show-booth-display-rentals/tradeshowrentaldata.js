...
export default function GetTradeRentaldata() {
        ...
        <div className="bg-white  relative py-20">
          <div className="container mx-auto px-4">
            <div className="max-w-3xl mx-auto text-center">
              <h2 className="maintitle text-gray-700 mb-6 max-w-2xl mx-auto">
                Custom Crafted. Ready to Deliver
              </h2>
              <p className="text-xl text-gray-700">
              We take the stress out of renting trade show booths by giving your marketing team a smooth, worry-free experience. Browse our selection of ready-to-use booth designs—each one customizable to match your brand and suitable for any event location or budget.
              </p>
            </div>
