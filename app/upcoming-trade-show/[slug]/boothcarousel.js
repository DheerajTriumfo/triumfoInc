          ...
          <div className="container mx-auto px-4">
            <div className="max-w-3xl mx-auto text-center">
              <h2 className="maintitle text-white mb-6 max-w-2xl mx-auto">
                Exhibit Rental Solutions That Work
              </h2>
              <p className="text-xl text-red-500 mb-6">1,000+ Designs. Any Size. Fully Customizable.</p>
              <p className="text-xl text-white">
                Design your booth from the ground up — tailored layouts, finishes, and experiences for maximum impact at every show.
              </p>
            </div>
                  ...
                  <div className="colloverlay bg-[linear-gradient(180deg,rgba(32,32,32,0)_75%,#0f0f0f_96%)] absolute top-0 left-0 w-full h-full">
                    <div className="caption text-center absolute left-0 bottom-[40px] block w-full">
                      <Link href={r.href || ""}>
                        ...
                        <div className="eyeebrow text-white text-base font-heading font-semibold">{r.countText}</div>
                      </Link>
                    </div>
                  </div>
                </div>
