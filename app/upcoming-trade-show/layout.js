...
export async function generateMetadata() {
  return await buildMetadata({
    ...
    alternates: {
      canonical: "/upcoming-trade-show/",
    },

    openGraph: {
      title: "Don’t Miss These Upcoming Trade Shows in the USA",
      description:"Stay ahead with our list of upcoming trade shows in the USA. Discover key exhibitions, plan your visit, and maximize your trade show experience with Triumfo Inc.",
      url: "/upcoming-trade-show/",
      siteName: "Triumfo Inc.",
      locale: "en_US",
      type: "website",
      images: [
        {
          url: "https://www.triumfo.us/images/tradeshow-detail2.webp",
          width: 1200,
          height: 630,
        },
      ],
    ...
    twitter: {
      ...
      description:"Stay ahead with our list of upcoming trade shows in the USA. Discover key exhibitions, plan your visit, and maximize your trade show experience with Triumfo Inc.",
      images: [
        "https://www.triumfo.us/images/tradeshow-detail2.webp",
      ],
    },
  });
};
